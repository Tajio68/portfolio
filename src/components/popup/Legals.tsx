...
const Legals: React.FunctionComponent<LegalsProps> = () => {
    return (
        <div id="legals">
            <h2 className="titleCenter">Mentions légales</h2>
            <h3 className="titleCenter">En vigueur au 26/09/2023</h3>
            <p>Conformément aux dispositions des Articles 6-III et 19 de la Loi n°2004-575 du 21 juin 2004 pour la
                ...
                visiteurs, ci-après l'Utilisateur, du site timeo-godin.com , ci-après le Site, les présentes mentions
                légales.</p>
            ...
            <p>L'hébergeur du Site est la société Timéo GODIN, dont le siège social est situé au 59 Grand Rue
                Meyenheim , avec le numéro de téléphone : 33650255325 + adresse mail de contact
            </p>
